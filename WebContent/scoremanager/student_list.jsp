...
<c:import url="base.jsp">
    ...
    <c:param name="content">
        <section class="mo-4">
            <h2 class="h3 mb-3 fw-norma bg-secondery bg-opacity-10 py-2 px-4">学生管理</h2>
            ...
            <form method="get">
                <div class="row border mx-3 mb-3 py-2 align-items-center rounded" id="filter">
                    ...
                    <div class="col-2 form-check test-center">
                    ...
                    <div class="mt-2 text-marning">${errors.get("f1")}</div>
                </div>
            </form>
            <c:choose>
